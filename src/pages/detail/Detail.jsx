    ...
    <div className="container min-h-[80vh] py-5 grid grid-cols-2 gap-8">
      ...
      <div>
        ...
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-green-300 to-emerald-400 text-white font-medium rounded-lg shadow-lg transition-all duration-300 hover:brightness-90"
